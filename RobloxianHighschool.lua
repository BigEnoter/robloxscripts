local bob = Instance.new("Message")
bob.Parent = Workspace
bob.Text = "Press k to enable Titan script"
wait(4)
bob:Remove()
wait(1)
...
game.Players.LocalPlayer:GetMouse().KeyDown:Connect(function(key)
	wait(0.01)
	if key:lower() == "k" or key:upper() == "K" then
		pressed = not pressed
		if(pressed) then
			wait(0.1)
			loadstring(game:HttpGet(("https://pastebin.com/raw/kWB7qXnR"),true))()
		end
	end
end)

--Made by Amunish.
local color = Color3.new(198, 84, 255) --Color you want here!
